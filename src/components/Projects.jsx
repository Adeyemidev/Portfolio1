...
export const Projects = ()=>{
    ...
    <div className="grid sm:grid-cols-2 gap-y-10 mx-4 sm:mx-4 md:mx-6 lg:mx-28 gap-10 pb-28">
       ...
       <a href="https://countries-apis-adeyemi.netlify.app/"><div> <img src={page2} alt=''/>
       ...
       <a href="https://designo-ade.netlify.app/"><div><img src={page3} alt=''/>
       ...
       <menu className='flex gap-5'><span>JAVASCRIPT</span> <span>TAILWINDCSS</span><span>REACTJS</span></menu>
        ...
        <a href="https://marketplace.cryptix.app/ "><div><img src={page5} alt="page5"/>
        <p className='text-[24px] leading-medium font-medium pt-5 pb-2'>CRYPTIX</p>
       <menu className='flex gap-5'><span>REACT</span> <span>NEXTJS</span> <span>JAVASCRIPT</span></menu>
        </div></a>

<a href="https://adeyemi-sunny-side.netlify.app/">
